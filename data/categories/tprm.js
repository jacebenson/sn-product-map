module.exports = {
  ...
  products: [
    { 
      ...
      tables: [
        { "sn_vdr_risk_vendor": "sys_created_onRELATIVEGT@dayofweek@ago@90^ORDERBYDESCsys_created_on" }
      ], 
    ...
    { 
      name: "Third-Party Risk Mgmt", 
      tables: [
        { "sn_vdr_risk_third_party": "sys_created_onRELATIVEGT@dayofweek@ago@90^ORDERBYDESCsys_created_on" }
      ], 
