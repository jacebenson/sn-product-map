module.exports = {
  ...
  products: [
    { 
      ...
      tables: [
        { "sys_app": "sys_created_onRELATIVEGT@dayofweek@ago@90^ORDERBYDESCsys_created_on" }
      ], 
    ...
    { 
      name: "App Template", 
      tables: [
        { "sys_app_template": "sys_created_onRELATIVEGT@dayofweek@ago@90^ORDERBYDESCsys_created_on" }
      ], 
    ...
    { 
      ...
      tables: [
        { "sys_db_object": "sys_created_onRELATIVEGT@dayofweek@ago@90^ORDERBYDESCsys_created_on" }
      ], 
    ...
    { 
      ...
      tables: [
        { "sys_app_mgmt": "sys_created_onRELATIVEGT@dayofweek@ago@90^ORDERBYDESCsys_created_on" }
      ], 
